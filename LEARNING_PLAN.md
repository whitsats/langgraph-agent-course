...
| 21 | 沙箱与权限（跑代码/危险工具） | 第 9.5 节 | ★★ | 生产必需；攻击复现与三层防线见第 16 章（附录C） |
| 22 | 评测（Evals） | 第 10.1 节 | ★★★ | 没有它所有优化都是猜；任务级断言见第 17 章（附录D） |
...
| 39 | 生产代码精读 / 逆向规格化 | 第 19 章（附录F） | ★★ | **可选，约 1 周，不进 5 周核心**；第 12 章"六问审阅法"的进阶，方法引自 SDD L11，交付物 = spec + 偏差清单 |
